...
export default function MarkdownInput({
  ...
  const updateContent = e => {
    setCurrentDoc(doc => ({...doc, content: e.target.value}))
  }
...
const PreviewToggler = styled(UnstyledButton)`
  &:hover {
    svg {
      path {
        fill: var(--orange);
...
const TextArea = styled.textarea`
  ...
  font-family: var(--ff-markdown-input);
  line-height: 1.5;
